...
namespace ITCaseTrack.Application.Features.Contacts.Handlers.Commands
{
    public class UpdateContactRequestHandler
     : UpdateRequestHandler<IContactRepository, ContactDto, ContactDtoValidator, Contact>
    {
        public UpdateContactRequestHandler(IContactRepository repository, IMapper mapper, ContactDtoValidator validator)
