...
{
    public class UpdateAppSystemRequestHandler : UpdateRequestHandler<IAppSystemRepository, AppSystemDto, AppSystemDtoValidator, AppSystem>
    {
        public UpdateAppSystemRequestHandler(IAppSystemRepository repository, IMapper mapper, AppSystemDtoValidator validator) 
